package com.dameninngenn.andenginecontrolertest;
...
public class AndEngineControlerTest extends BaseGameActivity {
	...
	public Scene onLoadScene() {
		...
		velocityOnScreenControl.getControlBase().setScale(0.8f);
		velocityOnScreenControl.getControlKnob().setScale(0.8f);
